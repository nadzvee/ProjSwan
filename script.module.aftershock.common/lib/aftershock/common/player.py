    ...
    def getVideoInfo(self, content, name, year, imdb, tvdb):
        ...
        try:
            if control.setting('resume_playback') == 'true':
                ...
                yes = control.yesnoDialog('%s %02d:%02d:%02d' % (
                control.lang(30461).encode('utf-8'), hours, minutes, seconds), '', '', self.name, control.lang(30463).encode('utf-8'), control.lang(30462).encode('utf-8'))
