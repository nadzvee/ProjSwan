...
class Notification(object):
    ...
    def scheduleNotifications(self):
        xbmc.log("[script.aftershocknow.guide] Scheduling notifications")
    ...
    def addNotification(self, program):
        ...
        self._scheduleNotification(program.channel.title, program.scheduleid, program.startDate)

    def removeNotification(self, program):
        self.database.removeNotification(program)
        self._unscheduleNotification(program.scheduleid, program.startDate)
